    ...
    <div class="py-12 bg-slate-50/50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100 p-8">
                <form action="{{ route('admin.pool-locations.update', $poolLocation) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="package_name" id="package_name" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('package_name', $poolLocation->package_name) }}">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" required class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('name', $poolLocation->name) }}">
                            ...
                            <div>
                                ...
                                <select name="meeting_count" id="meeting_count" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    @for($i = 1; $i <= 8; $i++)
                                        <option value="{{ $i }}" {{ old('meeting_count', $poolLocation->meeting_count) == $i ? 'selected' : '' }}>{{ $i }} Kali</option>
                                    @endfor
                                </select>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="coach_fee" id="coach_fee" required min="0" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('coach_fee', $poolLocation->coach_fee) }}">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="cash_percentage" id="cash_percentage" required min="0" max="100" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('cash_percentage', $poolLocation->cash_percentage) }}">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="private_ticket_price" id="private_ticket_price" min="0" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('private_ticket_price', $poolLocation->private_ticket_price) }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="semi_private_ticket_price" id="semi_private_ticket_price" min="0" class="mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('semi_private_ticket_price', $poolLocation->semi_private_ticket_price) }}">
                            </div>
                        </div>
                    </div>
