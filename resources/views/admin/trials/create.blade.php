    ...
    <div class="py-12 bg-slate-50/50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100 p-8">
                ...
                <form action="{{ route('admin.trials.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500" placeholder="Masukkan nama murid">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="age" id="age" value="{{ old('age') }}" required min="1" class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500" placeholder="Contoh: 10">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="school" id="school" value="{{ old('school') }}" class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500" placeholder="Opsional">
                            </div>

                            <!-- Kontak -->
                            <div>
                                <label for="contact_number" class="block text-sm font-semibold text-slate-700 mb-1">Nomor Kontak (WA)</label>
                                <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number') }}" class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500" placeholder="08xxxxxxxxxx">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="schedule_date" id="schedule_date" value="{{ old('schedule_date') }}" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="schedule_time" id="schedule_time" value="{{ old('schedule_time') }}" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="coach_id" id="coach_id" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                                <option value="" disabled {{ old('coach_id') ? '' : 'selected' }}>Pilih Pelatih</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="payment_amount" id="payment_amount" value="{{ old('payment_amount') }}" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500 format-rupiah" placeholder="Contoh: 150.000">
                            ...
                            <div>
                                ...
                                <select name="payment_method" id="payment_method" required class="w-full rounded-xl border-slate-300 focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    <option value="Tunai/Cash" {{ old('payment_method') === 'Tunai/Cash' ? 'selected' : '' }}>Tunai / Cash</option>
                                    ...
                                    <option value="E-Wallet (OVO/Dana/GoPay)" {{ old('payment_method') === 'E-Wallet (OVO/Dana/GoPay)' ? 'selected' : '' }}>E-Wallet (OVO/Dana/GoPay)</option>
                                    <option value="Gratis/Free Trial" {{ old('payment_method') === 'Gratis/Free Trial' ? 'selected' : '' }}>Gratis / Free Trial</option>
                                </select>
                            </div>
                        </div>
