            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100 p-8">
                ...
                <form action="{{ route('finance.payments.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="credit" id="credit" placeholder="Contoh: 150.000" class="w-full rounded-xl border-slate-200 focus:border-blue-500 focus:ring-blue-500 shadow-sm text-sm">
                    ...
                    <!-- Bukti Transfer -->
                    <div class="mb-5">
                        <label class="block text-sm font-bold text-slate-700 mb-2">Upload Bukti Transfer (Opsional)</label>
                        ...
                        <p class="text-xs text-slate-500 mt-1">Kosongkan jika metode pembayaran cash/langsung.</p>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="notes" rows="2" placeholder="Contoh: Pembayaran melalui perwakilan, atau catatan lainnya..." class="w-full rounded-xl border-slate-200 focus:border-blue-500 focus:ring-blue-500 shadow-sm text-sm"></textarea>
