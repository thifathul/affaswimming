        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl p-8 border border-slate-100">
                ...
                <div class="mb-8 border-b border-slate-100 pb-5">
                    <h3 class="text-lg font-bold text-slate-800"><i class="fa-solid fa-user-plus mr-2 text-blue-500"></i> Formulir Pengguna Baru</h3>
                    <p class="text-sm text-slate-500 mt-1">Daftarkan akun login baru dengan tingkat peran akses yang disesuaikan secara aman.</p>
                </div>
                ...
                <form method="POST" action="{{ route('master.users.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <x-text-input id="name" class="block w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Nama Lengkap Anggota" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <x-text-input id="email" class="block w-full" type="email" name="email" :value="old('email')" required placeholder="email@contoh.com" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <select id="role" name="role" required>
                                <option value="" disabled selected>Pilih Hak Akses / Peran</option>
                                <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Admin (Pengelola)</option>
                                <option value="pelatih" {{ old('role') === 'pelatih' ? 'selected' : '' }}>Pelatih (Instruktur)</option>
                                <option value="murid" {{ old('role') === 'murid' ? 'selected' : '' }}>Murid (Siswa)</option>
                                <option value="master" {{ old('role') === 'master' ? 'selected' : '' }}>Master (Pemilik Club)</option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <x-text-input id="password_confirmation" class="block w-full" type="password" name="password_confirmation" required placeholder="Ulangi kata sandi di atas" />
                        </div>
