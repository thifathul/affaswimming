    ...
    <div class="py-12 bg-slate-50/50 min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-slate-100 p-8">
                ...
                <form action="{{ route('pelatih.reports.update', $trainingReport->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end gap-3 mt-8">
                        <a href="{{ route('pelatih.reports.index') }}" class="px-4 py-2 border border-slate-300 rounded-lg shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50">
                            Batal
                        </a>
