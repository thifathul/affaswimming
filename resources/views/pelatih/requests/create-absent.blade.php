                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm font-bold text-amber-800">
                                    Reschedule Khusus Murid Absen
                                </h3>
                                <div class="mt-2 text-sm text-amber-700">
                                    <p>Pengajuan jadwal ini khusus dibuat untuk murid-murid yang tidak hadir pada laporan hari ini:</p>
                                    <ul class="list-disc pl-5 mt-1 font-semibold">
                                        @foreach($absentStudents as $student)
                                            <li>{{ $student->name }}</li>
                                            <input type="hidden" name="absent_student_ids[]" value="{{ $student->id }}">
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
